    ...
    app.add_meow = function (m) {
        if (m.author != undefined){
            ...
            if (app.vue.reply_status == true){ // we are replying 
                ...
                if (m.total_replies == undefined){
                    console.log("if");
                    currentTotal = 0;
                }
                else{
                    console.log("else");
                    currentTotal = parseInt(m.total_replies); 
                }
                // console.log("currentTotal");
                // console.log(currentTotal);
                // console.log(app.vue.reply_owner); 
                ...
                new_m.reply_owner = app.vue.reply_index; // the reply's reply_owner is the current reply_index
                new_m.total_replies = currentTotal + 1; 
